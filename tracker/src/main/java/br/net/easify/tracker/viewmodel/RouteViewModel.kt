...
class RouteViewModel (application: Application) :
    ...
    fun fromRoutePath(routePath: RoutePath): SqliteRoutePath {
        return SqliteRoutePath(
            routePath.userRoutePathId,
            routePath.userRouteId,
            routePath.userRoutePathLat,
            routePath.userRoutePathLng,
            routePath.userRoutePathAltitude,
            routePath.userRoutePathDatetime
        )
    }
